export const ABILITY_SCHEMA = [
  ...
  'CREATE INDEX IF NOT EXISTS idx_character_acquired_abilities_character ON character_acquired_abilities(character_id, acquired_at, id)',
  'CREATE INDEX IF NOT EXISTS idx_character_acquired_abilities_definition ON character_acquired_abilities(ability_definition_id, character_id)',
  ...
  'CREATE INDEX IF NOT EXISTS idx_ability_definition_revision_history_definition ON ability_definition_revision_history(ability_definition_id, created_at, id)',
  ...
  'CREATE INDEX IF NOT EXISTS idx_character_ability_grant_log_character ON character_ability_grant_log(character_id, created_at, id)'
];