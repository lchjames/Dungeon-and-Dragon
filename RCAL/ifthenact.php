...
<html>
	<head>
<meta charset="utf-8">
<title> If...Then... Game</title>
<!--link rel="stylesheet" href="stylebut.css">-->
	</head>
    <body>
        <h1> If...Then... Game </h1>
		<p align="center"; style="font-size:20px; color:FF6800; font-family:Comic Sans MS;"> This activity is designed to teach the 
		participants to learn the "If...Then..." which is the basic statement of coding. 
		</p>
		</br>
		</br>
		<p style="font-size:17px; color:black; font-family:Comic Sans MS;"> If..then is basic statement for coding, The program 
		...
		<p style="font-size:17px; color:black; font-family:Comic Sans MS;"> For each game begin, One child will play the programmer 
