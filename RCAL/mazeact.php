...
<!--link rel="stylesheet" href="stylebut.css">-->
    ...
    <body>
		...
		<p align="center"; style="font-size:20px; color:FF6800; font-family:Comic Sans MS;"> This exercise uses association,repetition 
		...
		<p style="font-size:17px; color:black; font-family:Comic Sans MS;"> A team work maze that uses logic gates puzzles on gates 
		...
		<p style="font-size:17px; color:black; font-family:Comic Sans MS;"> the gate will be locked behind switches that act as the 
